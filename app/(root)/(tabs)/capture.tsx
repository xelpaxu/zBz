  ...
  return (
    <SafeAreaView
      style={[
        ...
        viewMode === "success" && styles.mainContainerSuccess,
      ]}
    >
      <View
        style={{
      ...
      >
        ...
        <TouchableOpacity
          style={[
            styles.uploadCard,
            viewMode === "success" && styles.uploadCardDimmed,
          ]}
          onPress={openGallery}
        >
          <View
            style={[
              styles.dashedCircle,
              viewMode === "success" && styles.dashedCircleDimmed,
            ]}
          >
            <Plus
              color={viewMode === "success" ? "#C7D2FE" : "#4F46E5"}
              size={28}
              strokeWidth={3}
            />
          </View>
          <Text
            style={[
              ...
              viewMode === "success" && styles.textDimmed,
            ]}
          >
            Upload a Document
          </Text>
        ...
        <View style={styles.actionRow}>
          <TouchableOpacity
            style={[
              styles.actionBtn,
              viewMode === "success" && styles.actionBtnDimmed,
            ]}
            onPress={openGallery}
          >
            <ImageIcon
